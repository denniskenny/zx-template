; ============================================================================
; tritone_template.asm - Beepola "Tritone v2" export with the song data stripped.
;
; Supplies the player engine + DRUM_SETTINGS only.  Two consumers:
;   tools/txt2tritone.py       copies everything above the song-layout marker
;                              at the end of this file, then appends the song
;                              generated from a .txt transcription
;   tools/gen_tritone_module.py --engine
;                              extracts everything above the MUSICDATA label
;                              as the shared linkable engine
;
; NOTE: neither the song-layout marker nor the MUSICDATA label may appear
; anywhere above their real positions - both tools split on the first match.
;
; Replace this file with any other Beepola Tritone export (song data optional)
; to change engine/drum/volume behaviour for every tune at once.
; ============================================================================
